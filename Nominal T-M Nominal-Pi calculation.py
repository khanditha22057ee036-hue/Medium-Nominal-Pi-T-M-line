...
The program calculates:
    ...
    7. Sending-end power
    8. Receiving-end power
    9. Transmission efficiency

Nominal-Pi equations:
...
def polar_form(value):
    """Return magnitude and phase angle of a complex number."""
    magnitude = abs(value)
...
def calculate_parameters(
    ...
    """Calculate Z, Y and Nominal-Pi ABCD parameters."""

    # Total series resistance and reactance
...
def main():
    ...
    try:
        ...
        # Convert receiving-end quantities
        Vr = polar_to_complex(
            Vr_magnitude,
            Vr_angle
        )
        ...
        # Calculate sending-end quantities
